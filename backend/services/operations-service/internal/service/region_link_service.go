...
type RegionLinkService interface {
	CreateRegionLink(ctx context.Context, payload *operationspb.CreateRegionLinkRequest) (*operationspb.IDResponse, error)
	ChangeRegionLink(ctx context.Context, payload *operationspb.ChangeRegionLinkRequest) (*operationspb.IDResponse, error)
	ListRegionLinks(ctx context.Context) (*operationspb.ListRegionLinksResponse, error)
	DeleteRegionLink(ctx context.Context, id string) (*operationspb.IDResponse, error)
}
...
func (s *regionLinkService) CreateRegionLink(ctx context.Context, payload *operationspb.CreateRegionLinkRequest) (*operationspb.IDResponse, error) {
	...
	IDResponse := &operationspb.IDResponse{Id: regionLinkID.String()}
	return IDResponse, nil
}

func (s *regionLinkService) ChangeRegionLink(ctx context.Context, payload *operationspb.ChangeRegionLinkRequest) (*operationspb.IDResponse, error) {
	...
	return &operationspb.IDResponse{Id: regionLinkID.String()}, nil
}

func (s *regionLinkService) ListRegionLinks(ctx context.Context) (*operationspb.ListRegionLinksResponse, error) {
	...
	return &operationspb.ListRegionLinksResponse{RegionLinks: regionLinks}, nil
}

func (s *regionLinkService) DeleteRegionLink(ctx context.Context, id string) (*operationspb.IDResponse, error) {
